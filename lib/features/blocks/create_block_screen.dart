          ...
          data: (blocks) {
            ...
            if (day != null) {
              ...
              for (final a in appts) {
                if (a.dateTime.year == day.year && a.dateTime.month == day.month && a.dateTime.day == day.day) {
                  busy.add(DateTimeRange(start: a.dateTime, end: a.endDateTime));
                }
              }
              for (final b in blocks) {
                if (b.start.year == day.year && b.start.month == day.month && b.start.day == day.day) {
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Motivo (ej: Almuerzo)'),
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Text(day == null ? 'Selecciona un día' : 'Día: ${dfDay.format(day)}'),
                        ),
                        TextButton(onPressed: _pickDay, child: const Text('Elegir día')),
                      ],
                    ),
